import {
  Ripple,
  script as script2
} from "./chunk-UGHBQAZ7.js";
import {
  script,
  useStyle
} from "./chunk-XR2RKAGI.js";
import {
  DomHandler,
  ObjectUtils,
  UniqueComponentId,
  ZIndexUtils
} from "./chunk-JVEU3M3N.js";
import {
  Fragment,
  createBaseVNode,
  createBlock,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      key: 1,
      item: processedItem.item
    }, null, 8, ["item"]))], 16, _hoisted_24), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_MenubarSub, {
      key: 0,
      menuId: $props.menuId,
      role: "menu",
